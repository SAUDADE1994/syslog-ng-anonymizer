...
file_input_log_path = "/home/saudade/Fake-Apache-Log-Generator/access_log_20201221-183718.log"

#File path of the desired output file
file_output_log_path = "anon.log"

#File path where you want the bloom filter to be saved
file_filter_path = "../bloomfilter/filter.bloom"

#A list of bot/crawler/spider user agent excerpts - this file is included in the repository
file_bots_path = "../bloomfilter/bot-user-agents.txt"

#A list of user agent excerpts associated with different browsers - this file is included in the repository
file_browsers_path = "../bloomfilter/browser-user-agents.txt"

#The current counter IP address
file_counter_ip_path = "../bloomfilter/counter-ip-address.txt"
